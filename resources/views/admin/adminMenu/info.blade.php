                ...
                <form class="form-horizontal" role="form" method="POST" action="{{isset($info->id)?'edit':'add'}}">
                    ...
                    <div class="form-group">
                        ...
                        <span class="input-icon input-icon-left">
                            <input type="text" id="form-field-icon-2" name="icon" value="{{$info->icon or ''}}">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input type="text" name="c" value="{{$info->c or ''}}" class="col-xs-10 col-sm-8">
                        </div>
                    </div>
                    <div class="space-4"></div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input type="text" name="a" value="{{$info->a or ''}}" class="col-xs-10 col-sm-8">
                        </div>
                    </div>
                    <div class="space-4"></div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input type="text" name="data" value="{{$info->data or ''}}" class="col-xs-10 col-sm-8">
                        </div>
                    </div>
                    <div class="space-4"></div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input type="text" name="listorder" value="{{$info->listorder or '999'}}"
                                   class="col-xs-10 col-sm-8">
                        </div>
                    </div>
                    <div class="space-4"></div>
