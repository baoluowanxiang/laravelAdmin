    ...
    <div id="sidebar" class="sidebar  responsive   ace-save-state">
        ...
        <div class="sidebar-shortcuts" id="sidebar-shortcuts">
            <div class="sidebar-shortcuts-large" id="sidebar-shortcuts-large">
                <button class="btn btn-success" onclick="javascript:window.location.href = '/admin/crontab/index'">
                ...
                <button class="btn btn-danger" onclick="javascript:window.location.href = '/admin/site/info'">
