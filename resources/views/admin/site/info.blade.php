                    ...
                    <div class="tab-content">
                        <div role="tabpanel" class="tab-pane active" id="web-title">
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name="info[title]" value="{{$info->title or ''}}"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name="info[admin_title]" value="{{$info->admin_title or ''}}"
                                           class="col-xs-10 col-sm-8">
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <textarea name="info[keywords]" class="col-xs-10 col-sm-8" rows="2" cols="10"
                                              style="height:100px;">{{$info['keywords'] or ''}}</textarea>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <textarea name="info[description]" class="col-xs-10 col-sm-8" rows="2" cols="10"
                                              style="height:100px;">{{$info['description'] or ''}}</textarea>
                                </div>
                            </div>
                        </div>
                        ...
                        <div role="tabpanel" class="tab-pane" id="other">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <textarea name="info[setting][mail]" class="col-xs-10 col-sm-8" rows="2" cols="10" style="height:100px;">{{$info['setting']['mail'] or ''}}</textarea>
                                </div>
                            </div>
