            ...
            <div class="col-xs-12">
                ...
                <form class="form-horizontal" role="form" method="POST" action="{{isset($info->id)?'edit':'add'}}">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input type="text" name="name" value="{{$info->name or ''}}" {{isset($info->id)?'disabled':''}} class="col-xs-7">
                        </span>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-3">
                            {{From::select(M('AdminUser')->status_arr,isset($info->status)?$info->status:'','class="form-control" name="status" class="col-xs-10 col-sm-8"','--请选择--')}}
                        </div>
                    </div>
