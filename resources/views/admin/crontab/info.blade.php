            ...
            <div class="col-xs-12">
                ...
                <form class="form-horizontal" role="form" method="POST" action="{{isset($info->id)?'edit':'add'}}">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input type="text" name="name" value="{{$info->name or ''}}" class="col-xs-10 col-sm-8" required>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-3 control-label no-padding-right"> <span class="red">*</span> 代码 </label>
                        <div class="col-sm-9">
                            <input type="text" name="code" value="{{$info->code or ''}}" placeholder="app/Kernel.php 中的 case 值" class="col-xs-10 col-sm-8" required>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input type="text" name="crontab" value="{{$info->crontab or ''}}" placeholder="* * * * *" class="col-xs-10 col-sm-8" required>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input type="text" name="description" value="{{$info->description or ''}}" class="col-xs-10 col-sm-8">
                        </div>
                    </div>
